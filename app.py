...
@st.cache_resource
def load_assets():
    # The file name must match EXACTLY what you saved
...
# --- DASHBOARD METRICS (HARDCODED FROM YOUR NOTEBOOK RESULTS) ---
...
if st.sidebar.button("Predict Customer Risk"):
    ...
    input_data = {
        ...
        # NOTE: If your model used other columns (like PaperlessBilling), add them here!
    }
    ...
    # 5. Prediction
    # We use [:, 1] to get the probability of Class 1 (Churn)
